$(document).ready(function() {
  ...
  $("#fetch-weather").click(function() {
    ...
    $.getJSON("http://api.openweathermap.org/data/2.5/weather?" + currlat + "=35&lon=" + currlon + "&appid=bd82977b86bf27fb59a04b61b657fb6f", function(data) {
      console.log(this.weather[0].value);
      $("#test").text();
    })
  });
  ...
  /*$.getJSON('http://www.ip-api.com/json/', function(data) {
    $.forEach(function() {
      var outlat = this.lat;
      var outlon = this.lon;
      var result = api.openweathermap.org/data/2.5/weather?lat={outlat}&lon={outlon}
      $("#weather-results").text(result);
    })
  });*/
